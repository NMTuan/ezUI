...
}).call(this,require("XJF/FV"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_a158bc08.js","/")
...
var _upload = {
  ...
  renderItem: function renderItem() {
    ...
    $.each(s.values, function (i, item) {
      ...
      if (s.params.type === 'image') {
        label.addClass('ez-cursor-search');
      }
